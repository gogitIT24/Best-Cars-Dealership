...
def initiate():
    logger.info("Initiate function called")
    car_make_data = [
    ...
    car_model_data = [
        ...
        car_make_instances[4], "dealer_id": 1},
